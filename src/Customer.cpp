...
bool Customer::canMakeOrder() const{return static_cast<int>(ordersId.size())<maxOrders;} //Returns true if the customer didn't reach max orders
...
{
    return "customerID: " +to_string(id) + "\nNum orders left: " +to_string(getNumordersleft());
}
